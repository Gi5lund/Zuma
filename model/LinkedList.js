export class LinkedList {
    ...
    findMatchesNearby(node){
        // find all prev matches and then all next matches
        const matches = [node];
        let before=node;
        while(before.prev!=null && before.prev.value==node.value){
          matches.push(before.prev);
          before=before.prev;
        }
        let after=node;
        while(after.next!=null && after.next.data==node.value){
